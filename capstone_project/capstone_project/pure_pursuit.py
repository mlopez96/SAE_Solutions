...
class PurePursuit(Node):
    def __init__(self):
        ...
        self.pub = self.create_publisher(Twist, '/pure_pursuit/cmd_vel', 10)
    ...
    def read_points(self):
        ...
        file_path = os.path.join(os.path.expanduser('~'), 'sae_ws/git_ws/bootcamp-assignments/capstone_project/waypoints', file_name)
